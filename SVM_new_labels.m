%% SVM ~ One Specific Malignant Subclass vs All Malignant and Benign Subclasses
...
rgb_haar_vectors(:,759) = -1;
rgb_haar_vectors(1:3452,759) = 1;
seed = (1:5);

benign1 = (1:24);
benign2 = (63:82);
rest_benign = horzcat(benign1, benign2);
ductal = (25:62);
...
for x = 1:5
    ...
    randomized_benign = rest_benign(randperm(length(rest_benign)));
