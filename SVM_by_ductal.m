%% SVM ~ One Specific Malignant Subclass vs All Benign
...
~ 756 = 3 colors* 4 coeffs * 7 levels * 9 statistical parameters
...
%% Partition Method 1
%{
% 80% of the 82 Patients will be training data
num_train_patients = round(num_patients*0.7);

% 20% of the 82 Patients will be testing data
...
%% Partition Method 2
%{   
randomized_malignant = ductal(randperm(length(ductal)));
...
train_patient_IDs = horzcat(x1,x2);
test_patient_IDs = horzcat(x3,x4);

%% 100X SVM
tic;

% Identify Benign and Mucinous
benign_rows_100 = ismember(X100(:,end-1),benign);
duc_rows_100 = ismember(X100(:,end-1),ductal);

benign_vectors_100 = X100(benign_rows_100,:);
duc_vectors_100 = X100(duc_rows_100,:);

benign_vectors_100(:,end-1) = benign_vectors_100(:,end-1) ;
duc_vectors_100(:,end-1) = duc_vectors_100(:,end-1) ;

subclass_100 = [benign_vectors_100; duc_vectors_100];
...
% Identify benign and Mucinous
benign_rows_200 = ismember(X200(:,end-1),benign);
duc_rows_200 = ismember(X200(:,end-1),ductal);

benign_vectors_200 = X200(benign_rows_200,:);
duc_vectors_200 = X200(duc_rows_200,:);

benign_vectors_200(:,end-1) = benign_vectors_200(:,end-1) ;
duc_vectors_200(:,end-1) = duc_vectors_200(:,end-1) ;

subclass_200 = [benign_vectors_200; duc_vectors_200];
...
% Identify benign and Mucinous
benign_rows_400 = ismember(X400(:,end-1),benign);
duc_rows_400 = ismember(X400(:,end-1),ductal);

benign_vectors_400 = X400(benign_rows_400,:);
duc_vectors_400 = X400(duc_rows_400,:);

benign_vectors_400(:,end-1) = benign_vectors_400(:,end-1) ;
duc_vectors_400(:,end-1) = duc_vectors_400(:,end-1) ;

subclass_400 = [benign_vectors_400; duc_vectors_400];
...
% Identify benign and Mucinous
benign_rows_40 = ismember(X40(:,end-1),benign);
duc_rows_40 = ismember(X40(:,end-1),ductal);

benign_vectors_40 = X40(benign_rows_40,:);
duc_vectors_40 = X40(duc_rows_40,:);

benign_vectors_40(:,end-1) = benign_vectors_40(:,end-1) ;
duc_vectors_40(:,end-1) = duc_vectors_40(:,end-1) ;

subclass_40 = [benign_vectors_40; duc_vectors_40];
